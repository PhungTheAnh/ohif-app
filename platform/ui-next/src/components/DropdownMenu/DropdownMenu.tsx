...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'bg-secondary-dark text-popover-foreground border-input z-50 min-w-[8rem] overflow-hidden rounded border border-[#e6f7fa] p-1 shadow-md',
